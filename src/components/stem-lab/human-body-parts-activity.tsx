...
const bodyParts: BodyPart[] = [
  { id: '1', label: 'Forehead muscle', explanation: 'This muscle helps lift the eyebrows and wrinkle the forehead.', side: 'left', top: '4.85%' },
  { id: '2', label: 'Eye muscle', explanation: 'This ring-shaped muscle helps close and blink the eye.', side: 'left', top: '8.1%' },
  { id: '3', label: 'Mouth muscle', explanation: 'This muscle helps move the lips for smiling, speaking, and eating.', side: 'left', top: '11.35%' },
  { id: '4', label: 'Neck muscle', explanation: 'This long muscle helps turn and bend the head and neck.', side: 'left', top: '14.65%' },
  { id: '5', label: 'Upper back muscle', explanation: 'This broad muscle helps support and move the neck and shoulders.', side: 'left', top: '18%' },
  { id: '6', label: 'Shoulder muscle', explanation: 'This muscle helps lift the arm away from the body.', side: 'left', top: '21.35%' },
  { id: '7', label: 'Chest muscle', explanation: 'This muscle helps bring the arm across the front of the body.', side: 'left', top: '24.65%' },
  { id: '8', label: 'Upper arm muscle', explanation: 'This front-of-arm muscle helps bend the elbow.', side: 'right', top: '34.8%' },
  { id: '9', label: 'Side body muscle', explanation: 'These side muscles help support the trunk and bend the body.', side: 'left', top: '35.8%' },
  { id: '10', label: 'Abdominal muscle', explanation: 'These front muscles help hold the trunk steady and bend the body.', side: 'right', top: '40.7%' },
  { id: '11', label: 'Hip muscle', explanation: 'This muscle helps lift and move the leg at the hip.', side: 'left', top: '47%' },
  { id: '12', label: 'Diagonal thigh muscle', explanation: 'This long muscle crosses the thigh and helps bend the hip and knee.', side: 'left', top: '64.25%' },
  { id: '13', label: 'Inner thigh muscle', explanation: 'This muscle pulls the leg inward toward the body.', side: 'right', top: '60.7%' },
  { id: '14', label: 'Inner knee muscle', explanation: 'This thigh muscle helps straighten the knee.', side: 'right', top: '68.6%' },
  { id: '15', label: 'Kneecap', explanation: 'This small bone protects the front of the knee joint.', side: 'left', top: '72.9%' },
  { id: '16', label: 'Front lower-leg muscle', explanation: 'This muscle helps lift the foot and toes upward.', side: 'left', top: '78.4%' },
  { id: '17', label: 'Outer calf muscle', explanation: 'This muscle on the outside of the lower leg helps move the foot.', side: 'left', top: '82.5%' },
  { id: '18', label: 'Calf muscle', explanation: 'This strong muscle helps push the foot down when walking or jumping.', side: 'right', top: '79.1%' },
  { id: '19', label: 'Side calf muscle', explanation: 'This muscle helps turn and steady the foot and ankle.', side: 'right', top: '83.3%' },
  { id: '20', label: 'Big-toe lifting muscle', explanation: 'This muscle helps lift the big toe upward.', side: 'left', top: '86.9%' },
  { id: '21', label: 'Toe-lifting muscles', explanation: 'These muscles help lift and straighten the toes.', side: 'right', top: '87.6%' },
]
