...
const bodyParts: BodyPart[] = [
  ...
  { id: '12', label: 'Diagonal thigh muscle', explanation: 'This long muscle crosses the thigh and helps bend the hip and knee.', side: 'left', top: '61.5%' },
  { id: '13', label: 'Inner thigh muscle', explanation: 'This muscle pulls the leg inward toward the body.', side: 'right', top: '58%' },
  { id: '14', label: 'Inner knee muscle', explanation: 'This thigh muscle helps straighten the knee.', side: 'right', top: '65.5%' },
  { id: '15', label: 'Kneecap', explanation: 'This small bone protects the front of the knee joint.', side: 'left', top: '70%' },
  { id: '16', label: 'Front lower-leg muscle', explanation: 'This muscle helps lift the foot and toes upward.', side: 'left', top: '75.5%' },
  { id: '17', label: 'Outer calf muscle', explanation: 'This muscle on the outside of the lower leg helps move the foot.', side: 'left', top: '79.5%' },
  { id: '18', label: 'Calf muscle', explanation: 'This strong muscle helps push the foot down when walking or jumping.', side: 'right', top: '77.2%' },
  { id: '19', label: 'Side calf muscle', explanation: 'This muscle helps turn and steady the foot and ankle.', side: 'right', top: '80.5%' },
  { id: '20', label: 'Big-toe lifting muscle', explanation: 'This muscle helps lift the big toe upward.', side: 'left', top: '84%' },
  { id: '21', label: 'Toe-lifting muscles', explanation: 'These muscles help lift and straighten the toes.', side: 'right', top: '83.5%' },
]
