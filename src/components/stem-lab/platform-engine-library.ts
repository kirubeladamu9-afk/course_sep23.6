...
export const PLATFORM_ENGINES: PlatformEngineDefinition[] = [
  ...
  { id: 'machine-playground', name: 'Machine Playground', description: 'Explore the mechanical advantage of levers, pulleys, and ramps.', subjects: ['Physics'], examples: ['Adjusting a fulcrum', 'Adding pulley wheels', 'Changing ramp angle'], interaction: 'Change a machine and use calculated force and distance to move a heavy box.' },
